      ...
      >
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 md:gap-8">
          ...
          <motion.div variants={footerItem} className="lg:col-span-1">
            ...
            <p className="font-body text-cream/70 text-sm leading-relaxed mb-6 max-w-sm">
            ...
            <div className="flex gap-4">
              <a href="https://instagram.com/magpiecottage_" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-cream/10 hover:bg-cream/20 flex items-center justify-center transition-all duration-300" aria-label="Instagram">
