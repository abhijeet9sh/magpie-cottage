...
import { footerStagger, footerItem } from "@/lib/animations";
    ...
    <footer className="bg-forest text-cream">
      ...
      >
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 md:gap-8">
          ...
          <motion.div variants={footerItem} className="lg:col-span-1">
            ...
            <p className="font-body text-sage text-xs tracking-widest mb-6">Hosted by Malini</p>
            <div className="flex gap-4">
              <a href="https://www.instagram.com/magpiecottage_?igsh=MTZpMWIyYzJzNGxxMg==" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-cream/10 hover:bg-cream/20 flex items-center justify-center transition-all duration-300" aria-label="Instagram">
              ...
              <a href="https://facebook.com/magpiecottage" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-cream/10 hover:bg-cream/20 flex items-center justify-center transition-all duration-300" aria-label="Facebook">
                <svg className="w-[18px] h-[18px]" viewBox="0 0 24 24" fill="currentColor"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/></svg>
              </a>
              <a href="mailto:bookmagpiecottage@gmail.com" className="w-10 h-10 rounded-full bg-cream/10 hover:bg-cream/20 flex items-center justify-center transition-all duration-300" aria-label="Email">
                <Mail size={18} />
              </a>
            </div>
          </motion.div>
          ...
          <motion.div variants={footerItem}>
            ...
            <div className="flex flex-col gap-4">
              ...
              <a href="mailto:bookmagpiecottage@gmail.com" className="text-cream/70 hover:text-cream transition-colors duration-300 font-body text-sm flex items-center gap-2">
                <Mail size={14} />
      ...
      <div className="border-t border-cream/10">
        <div className="max-w-7xl mx-auto px-6 md:px-12 py-6 flex flex-col md:flex-row items-center justify-between gap-4">
          <div className="flex flex-wrap items-center gap-4 text-cream/50 text-xs font-body">
