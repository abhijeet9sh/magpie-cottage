...
const platforms = [
  ...
  {
    name: "WhatsApp",
    href: "https://wa.me/918882760940?text=Hi%2C%20I%27d%20like%20to%20book%20Magpie%20Cottage.%20Could%20you%20share%20availability%3F",
    icon: (
      <svg className="w-6 h-6" viewBox="0 0 24 24" fill="currentColor">
    ...
    <section className="py-16 md:py-20 px-6 md:px-12 bg-cream border-y border-stone-200/50">
      <AnimatedSection className="max-w-5xl mx-auto">
        <div className="text-left">
          ...
          <p className="font-body text-text-mid text-sm mb-10 max-w-md">
